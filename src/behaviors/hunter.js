...
function (Phaser, StateMachine) {
	...
	Hunter.prototype.update_idle = function () {
        ...
        if(this.distanceToTarget.getMagnitude() < 400) {
    ...
    Hunter.prototype.update_hunting = function () {
        ...
        // -- If player is within attack range, switch to "attack" state.
        	if(this.distanceToTarget.getMagnitude() < 64) {
    	...
    	// Give up if the player isn't where we last saw them.
    	else if (this.distanceToTarget.getMagnitude() > minDistance) {
    		this.stateMachine.setState('idle');
        }
    ...
    Hunter.prototype.update_attacking = function () {
        ...
        if(canSee && this.distanceToTarget.getMagnitude() < 128) {
    ...
    Hunter.prototype.shouldJump = function () {
        ...
        this.distanceToTarget.getMagnitude() < 64) && Math.random() < 0.05) return true;
